        ...
        <div class="container">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1><a class="main__logo--link" href="index.html"><img class="main__logo--img" src="frontend/img/panganketapang.svg" alt="logo-img"></a></h1>
                </div>
                    ...
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            ...
                            <li class="header__menu--items mega__menu--items">
                                <a class="header__menu--link" href="/pertanian">Hasil Pertanian 
                ...
                <div class="header__account">
                    <ul class="d-flex">
                        ...
                        <li class="header__account--items d-none d-lg-block">
                            <a class="header__account--btn" href="tambah">
                        ...
                        <li class="header__account--items d-none d-lg-block">
                            ...
                            <a class="header__account--btn" href="/profil">
                ...
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li"><a href="tambah" class="offcanvas__sub_menu_item">Wishlist Page</a></li>
    ...
    <div class="offcanvas__stikcy--toolbar">
        <ul class="d-flex justify-content-between">
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="/beranda">
            ...
            <li class="offcanvas__stikcy--toolbar__list ">
                <a class="offcanvas__stikcy--toolbar__btn" href="tambah">
                    <span class="offcanvas__stikcy--toolbar__icon"> 
                        <i class="fa-solid fa-plus fa-lg"></i>
                    </span>
                <span class="offcanvas__stikcy--toolbar__label">Jual</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                    ...
                    <span class="offcanvas__stikcy--toolbar__label">Favorit</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="akun">
                <span class="offcanvas__stikcy--toolbar__icon"> 
