<header class="header__section header__transparent">
        ...
        <div class="container">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1><a class="main__logo--link" href="index.html"><img class="main__logo--img"
                                src="{{asset('frontend/img/panganketapang.svg')}}" alt="logo-img"></a></h1>
                </div>
                <div class="header__menu d-none d-lg-block">
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="{{route('beranda.index')}}">Beranda

                                </a>

                            </li>
                            <li class="header__menu--items mega__menu--items">
                                <a class="header__menu--link" href="{{route('pertanian.index')}}">Hasil Pertanian
                                    <i class="fa-solid fa-seedling fa-lg text__secondary"></i>
                                </a>

                            </li>
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="{{route('peternakan.index')}}">Hasil Peternakan
                            ...
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="{{route('perikanan.index')}}">Hasil Perikanan
                ...
                <div class="header__account">
                    <ul class="d-flex">
                        ...
                        <li class="header__account--items">
                            <a class="header__account--btn" href="{{route('products.create')}}" data-offcanvas>
                        ...
                        {{-- <li class="header__account--items d-none d-lg-block">
                            <a class="header__account--btn" href="{{route('products.create')}}">
                                <i class="fa-solid fa-plus fa-lg"></i>
                            </a>
                        </li> --}}
                        <li class="header__account--items d-none d-lg-block">
    ...
    <!-- Start Offcanvas header menu TAMPILAN MOBILE -->
    <div class="offcanvas__header">
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="index.html">
                    <img src="frontend/img/panganketapang.svg" alt="Grocee Logo" width="158" height="36">
                </a>
            ...
            <nav class="offcanvas__menu">
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li"><a href="tambah"
                ...
                <div class="offcanvas__account--currency">
                    <a class="offcanvas__account--currency__menu text-black" href="javascript:void(0)">
                        <img src="frontend/img/icon/usd-icon.png' alt="currency">
                        <span>USD</span>
    ...
    <!-- Start Offcanvas stikcy toolbar BUTTON HP -->
    <div class="offcanvas__stikcy--toolbar">
        <ul class="d-flex justify-content-between">
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="/pangan-ketapang/beranda">
                    ...
                    <span class="offcanvas__stikcy--toolbar__label">Beranda</span>
                </a>
            </li>
            {{-- <li class="offcanvas__stikcy--toolbar__list">
                ...
                <span class="offcanvas__stikcy--toolbar__label">Katalog</span>
                </a>
            </li> --}}
            <li class="offcanvas__stikcy--toolbar__list ">
                <a class="offcanvas__stikcy--toolbar__btn" href="{{route('pertanian.index')}}" data-offcanvas>
                    <span class="offcanvas__stikcy--toolbar__icon">
                        <i class="fa-solid fa-seedling fa-lg"></i>
                    </span>
                    <span class="offcanvas__stikcy--toolbar__label">Pertanian</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list ">
                <a class="offcanvas__stikcy--toolbar__btn" href="{{route('peternakan.index')}}" data-offcanvas>
                    <span class="offcanvas__stikcy--toolbar__icon">
                        <i class="fa-solid fa-cow fa-lg"></i>
                    </span>
                    <span class="offcanvas__stikcy--toolbar__label">Peternakan</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="{{route('perikanan.index')}}"
                    data-offcanvas>
                    <span class="offcanvas__stikcy--toolbar__icon">
                        <i class="fa-solid fa-fish-fins fa-lg"></i>
                    </span>
                    <span class="offcanvas__stikcy--toolbar__label">Perikanan</span>
                </a>
            </li>
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn" href="{{route('profile.index')}}" data-offcanvas>
                    <span class="offcanvas__stikcy--toolbar__icon">
                        <i class="fa-solid fa-user"></i>
                    </span>
                    <span class="offcanvas__stikcy--toolbar__label">Akun</span>
                </a>
            </li>
        </ul>
    </div>
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="frontend/img/product/product1.p}}" alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="frontend/img/product/product2.p}}" alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
