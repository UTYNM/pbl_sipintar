            ...
            <div class="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
                ...
                <div class="product__view--mode d-flex align-items-center">
                    ...
                    <div class="product__view--mode__list product__view--search d-xl-block d-none">
                        <form class="product__view--search__form" action="{{ route('peternakan.index') }}"
                            method="GET">
                            <label>
                                <input class="product__view--search__input border-0" name="search"
                                    placeholder="Cari Hasil Peternakan" type="text"
                                    style="
                                    width: 280%;
                                "
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                        <div class="single__widget widget__bg">
                            ...
                            <form id="filterForm" method="GET" action="{{ route('peternakan.index') }}">
                                <ul class="widget__form--check">
                        ...
                        <div class="single__widget price__filter widget__bg">
                            ...
                            <form class="price__filter--form" method="GET" action="{{ route('peternakan.index') }}">
                                ...
                                @foreach ($districts as $district)
                                    <li class="widget__tagcloud--list">
                                        <a class="widget__tagcloud--link"
                                            href="{{ route('peternakan.index', ['district_id' => $district->id]) }}">
                                            {{ $district->name }}
                                        </a>
                                    </li>
                                @endforeach
