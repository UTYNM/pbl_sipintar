                    ...
                    <div class="swiper-slide">
                        <div class="product__items product__items2">
                            <div class="product__items--thumbnail">
                                <a class="product__items--link" href="{{ route('products.show', $relatedProduct->id) }}">
                                    <img class="product__items--img product__primary--img" src="{{ asset($relatedProduct->photos->first()->photo_url ?? 'default-image.png') }}" alt="product-img">
                                    <img class="product__items--img product__secondary--img" src="{{ asset($relatedProduct->photos->first()->photo_url ?? 'default-image.png') }}" alt="product-img">
                                </a>
                            </div>
