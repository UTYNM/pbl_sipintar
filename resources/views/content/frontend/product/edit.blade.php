...
@section('content')
    <!-- Start edit product page area -->
    <div class="edit__page--area">
        <div class="container">
            <div class="edit__page--inner d-flex">
                <div class="main edit__main" style="width: 100%;padding: 0 0 0 0;">
                    <main class="main__content_wrapper section--padding pt-0">
                        <div class="section__edit--address">
                            <div class="section__header mb-25">
                                <h2 class="section__header--title h3">Edit Produk</h2>
                            </div>
                            <div class="section__edit--address__content">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="edit__input--list">
                                                <label for="product_name">
                                                    <input class="form control checkout__input--field border-radius-5"
                                                        ...
                                                        value="{{ $product->product_name }}" required type="text">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 mb-12">
                                            <div class="edit__input--list">
                                                <label for="price">
                                                    <input class=" form control checkout__input--field border-radius-5"
                                                        placeholder="Harga" id="price" name="price" value="{{ $product->price }}" required
                                                        type="number">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 mb-12">
                                            <div class="edit__input--list">
                                                <label>
                                                    <input class=" form control checkout__input--field border-radius-5"
                                                    placeholder="Stok"
                                                        id="stock" name="stock" value="{{ $product->stock }}" required type="number">
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="checkout__input--list checkout__input--select select">
                                                ...
                                                <select class="checkout__input--select__field border-radius-5"
                                                    ...
                                                    @foreach ($category_types as $category_type)
                                                        <option value="{{ $category_type->id }}" @if($category_type->id == $product->category_type_id) selected @endif>{{ $category_type->type_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
