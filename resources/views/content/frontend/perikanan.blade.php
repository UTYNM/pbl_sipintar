            ...
            <div class="single__widget widget__bg">
                ...
                <ul class="widget__form--check">
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check1">Ikan Laut</label>
                        <input class="widget__form--check__input" id="check1" type="checkbox">
                        <span class="widget__form--checkmark"></span>
                    </li>
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check1">Ikan Air Tawar</label>
                        <input class="widget__form--check__input" id="check1" type="checkbox">
                        <span class="widget__form--checkmark"></span>
                    </li>
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check2">Udang</label>
                        <input class="widget__form--check__input" id="check2" type="checkbox">
                        <span class="widget__form--checkmark"></span>
                    </li>
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check3">Kepiting</label>
                        <input class="widget__form--check__input" id="check3" type="checkbox">
                        <span class="widget__form--checkmark"></span>
                    </li>
                    <li class="widget__form--check__list">
                        <label class="widget__form--check__label" for="check4">Olahan Ikan</label>
                ...
                <div class="product__view--mode d-flex align-items-center">
                    ...
                    <div class="product__view--mode__list product__view--search d-xl-block d-none ">
                        <form class="product__view--search__form" action="#">
                            <label>
                                <input class="product__view--search__input border-0" placeholder="Cari Hasil Perikanan"
                                    type="text">
                            </label>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__items2">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.html">
                                                        <img class="product__items--img product__primary--img"
                                                            src="frontend/img/ikan patin.png" alt="product-img">
                                                        <img class="product__items--img product__secondary--img"
                                                            src="frontend/img/ikan patin.png" alt="product-img">
                                                    </a>
                                                    <div class="product__badge">
                                                ...
                                                <div class="product__items--content product__items2--content text-center">
                                                    <a class="add__to--cart__btn" href="cart.html">+ Tambah Ke
                                                        Keranjang</a>
                                                    <h3 class="product__items--content__title h4"><a
                                                            href="product-details.html">Ikan Patin</a></h3>
                                                    <div class="product__items--price">
                                                        <span class="current__price">Rp 40.000/kg</span>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__items2">
                                                <div class="product__items--thumbnail">
                                                    <a class="product__items--link" href="product-details.html">
                                                        <img class="product__items--img product__primary--img"
                                                            src="frontend/img/ikan tongkol.png" alt="product-img">
                                                        <img class="product__items--img product__secondary--img"
                                                            src="frontend/img/ikan tongkol.png" alt="product-img">
                                                    </a>
                                                    <div class="product__badge">
                                                ...
                                                <div class="product__items--content product__items2--content text-center">
                                                    <a class="add__to--cart__btn" href="cart.html">+ Tambah Ke
                                                        Keranjang</a>
                                                    <h3 class="product__items--content__title h4"><a
                                                            href="product-details.html">Ikan Tongkol</a></h3>
                                                    <div class="product__items--price">
                                                        <span class="current__price">Rp 45.000/kg</span>
                                                    </div>
                                                    <span class="">Stock: 90kg</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
