                            ...
                            @foreach($product->photos as $photo)
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{ asset($photo->photo_url) }}">
                                            <img class="product__media--preview__items--img" src="{{ asset($photo->photo_url) }}" alt="product-media-img">
                                        </a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{ asset($photo->photo_url) }}" data-gallery="product-media-preview">
