                    ...
                    @foreach ($districts as $district)
                        <li class="widget__tagcloud--list">
                            <a class="widget__tagcloud--link"
                                href="{{ route('pertanian.index', ['district_id' => $district->id]) }}">
                                {{ $district->name }}
                            </a>
                        </li>
                    @endforeach
            ...
            <div class="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
                ...
                <div class="product__view--mode d-flex align-items-center">
                    ...
                    <div class="product__view--mode__list product__view--search d-xl-block d-none">
                        <form class="product__view--search__form" action="{{ route('pertanian.index') }}"
                            method="GET">
                            <label>
                                <input class="product__view--search__input border-0" name="search"
                                    placeholder="Cari Hasil Pertanian" type="text"
                                    style="
                                    width: 280%;
                                "
