                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product__media--preview__items">
                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="frontend/img/naga.png"><img class="product__media--preview__items--img" src="frontend/img/naga.png" alt="product-media-img"></a>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product__media--nav__items">
                                    <img class="product__media--nav__items--img" src="frontend/img/naga-2.png" alt="product-nav-img">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__media--nav__items">
                                    <img class="product__media--nav__items--img" src="frontend/img/naga-3.png" alt="product-nav-img">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__media--nav__items">
                                    <img class="product__media--nav__items--img" src="frontend/img/naga-4.png" alt="product-nav-img">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__media--nav__items">
                                    <img class="product__media--nav__items--img" src="frontend/img/naga-1.png" alt="product-nav-img">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="product__media--nav__items">
                                    <img class="product__media--nav__items--img" src="frontend/img/naga.png" alt="product-nav-img">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="reviews__comment--area">
                                    <div class="reviews__comment--list d-flex">
                                        <div class="reviews__comment--thumb">
                                            <img src="frontend/img/other/comment-thumb1.png" alt="comment-thumb">
                                        </div>
                                    ...
                                    <div class="reviews__comment--list margin__left d-flex">
                                        <div class="reviews__comment--thumb">
                                            <img src="frontend/img/other/comment-thumb2.png" alt="comment-thumb">
                                        </div>
                                        <div class="reviews__comment--content">
                                            <div class="reviews__comment--top d-flex justify-content-between">
                                                <div class="reviews__comment--top__left">
                                    ...
                                    <div class="reviews__comment--list d-flex">
                                        <div class="reviews__comment--thumb">
                                            <img src="frontend/img/other/comment-thumb3.png" alt="comment-thumb">
                                        </div>
                                        <div class="reviews__comment--content">
                                            <div class="reviews__comment--top d-flex justify-content-between">
                                                <div class="reviews__comment--top__left">
...
<section class="product__section product__section--style3 section--padding">
    <div class="container product3__section--container">
        <div class="section__heading3 text-center mb-40">
            <h2 class="section__heading3--maintitle">Produk Terkait</h2>
        </div>
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="product__items product__items2">
                        <div class="product__items--thumbnail">
                            <a class="product__items--link" href="product-details.html">
                                <img class="product__items--img product__primary--img" src="frontend/img/padi-2.png" alt="product-img">
                                <img class="product__items--img product__secondary--img" src="frontend/img/padi-2.png" alt="product-img">
                            </a>
                        ...
                        <div class="product__items--content product__items2--content text-center">
                            ...
                            <h3 class="product__items--content__title h4"><a href="product-details.html">Cabe Keriting</a></h3>
                ...
                <div class="swiper-slide">
                    <div class="product__items product__items2">
                        <div class="product__items--thumbnail">
                            <a class="product__items--link" href="product-details.html">
                                <img class="product__items--img product__primary--img" src="frontend/img/padi-5.png" alt="product-img">
                                <img class="product__items--img product__secondary--img" src="frontend/img/padi-5.png" alt="product-img">
                            </a>
                            <div class="product__badge">
                                {{-- <span class="product__badge--items sale">Sale</span> --}}
                            </div>
                        ...
                        <div class="product__items--content product__items2--content text-center">
                            <a class="add__to--cart__btn" href="cart.html">+ Tambah Ke Keranjang</a>
                            <h3 class="product__items--content__title h4"><a href="product-details.html">Jagung</a></h3>
                            <div class="product__items--price">
                                <span class="current__price">Rp 20.000/kg</span>
                                {{-- <span class="old__price">$59.00</span> --}}
                            </div>
                ...
                <div class="swiper-slide">
                    <div class="product__items product__items2">
                        <div class="product__items--thumbnail">
                            <a class="product__items--link" href="product-details.html">
                                <img class="product__items--img product__primary--img" src="frontend/img/padi-6.png" alt="product-img">
                                <img class="product__items--img product__secondary--img" src="frontend/img/padi-6.png" alt="product-img">
                            </a>
                            <div class="product__badge">
                                {{-- <span class="product__badge--items sale">Sale</span> --}}
                            </div>
                        ...
                        <div class="product__items--content product__items2--content text-center">
                            <a class="add__to--cart__btn" href="cart.html">+ Tambah Ke Keranjang</a>
                            <h3 class="product__items--content__title h4"><a href="product-details.html">Buah Mangga</a></h3>
                            <div class="product__items--price">
                ...
                <div class="swiper-slide">
                    <div class="product__items product__items2">
                        <div class="product__items--thumbnail">
                            <a class="product__items--link" href="product-details.html">
                                <img class="product__items--img product__primary--img" src="frontend/img/padi-7.png" alt="product-img">
                                <img class="product__items--img product__secondary--img" src="frontend/img/padi-7.png" alt="product-img">
                            </a>
                            <div class="product__badge">
                                {{-- <span class="product__badge--items sale">Sale</span> --}}
                            </div>
                        ...
                        <div class="product__items--content product__items2--content text-center">
                            <a class="add__to--cart__btn" href="cart.html">+ Tambah Ke Keranjang</a>
                            <h3 class="product__items--content__title h4"><a href="product-details.html">Semangka</a></h3>
                            <div class="product__items--price">
